...
-- Krijo admin user (passwordi: admin123 - i hash-uar)
INSERT INTO users (first_name, last_name, email, password_hash, is_verified, is_active)
VALUES ('Admin', 'User', 'admin@qent.com', '$2a$12$LQv3c1yqBWVHxkd0LHAkCOYz6TtxMQJqhN8/LewKAVnFs5ek/de4e', TRUE, TRUE);

-- Cakto role-in admin
INSERT INTO user_roles (user_id, role_id)
SELECT u.id, r.id FROM users u, roles r
WHERE u.email = 'admin@qent.com' AND r.name = 'admin';

INSERT INTO user_roles (user_id, role_id)
SELECT u.id, r.id FROM users u, roles r
WHERE u.email = 'emaili_yt@test.com' AND r.name = 'admin';
...
USE car_rental_app;
SELECT id, email, first_name, password_hash FROM users WHERE email = 'admin@test.com';

USE car_rental_app;

-- Fshij role-in e vjeter (customer)
...
-- Shto brand-et qe mungojne
INSERT INTO car_brands (name) VALUES ('Ferrari'), ('Lamborghini');

USE car_rental_app;
SELECT c.id, cb.name AS brand, c.model, c.status, co.verification_status
FROM cars c
...
-- A ka cars fare (pa JOIN)?
SELECT id, model, owner_id, brand_id FROM cars;


SELECT * FROM bookings ORDER BY id DESC;


UPDATE car_brands SET logo_url = 'https://logos-world.net/wp-content/uploads/2020/04/Tesla-Logo.png' WHERE name = 'Tesla';
UPDATE car_brands SET logo_url = 'https://logos-world.net/wp-content/uploads/2020/04/BMW-Logo.png' WHERE name = 'BMW';
UPDATE car_brands SET logo_url = 'https://logos-world.net/wp-content/uploads/2020/04/Mercedes-Benz-Logo.png' WHERE name = 'Mercedes-Benz';
UPDATE car_brands SET logo_url = 'https://logos-world.net/wp-content/uploads/2020/04/Audi-Logo.png' WHERE name = 'Audi';
UPDATE car_brands SET logo_url = 'https://logos-world.net/wp-content/uploads/2020/04/Toyota-Logo.png' WHERE name = 'Toyota';
UPDATE car_brands SET logo_url = 'https://logos-world.net/wp-content/uploads/2020/04/Honda-Logo.png' WHERE name = 'Honda';
UPDATE car_brands SET logo_url = 'https://logos-world.net/wp-content/uploads/2020/04/Ford-Logo.png' WHERE name = 'Ford';
UPDATE car_brands SET logo_url = 'https://logos-world.net/wp-content/uploads/2020/04/Chevrolet-Logo.png' WHERE name = 'Chevrolet';
UPDATE car_brands SET logo_url = 'https://logos-world.net/wp-content/uploads/2020/04/Porsche-Logo.png' WHERE name = 'Porsche';
UPDATE car_brands SET logo_url = 'https://logos-world.net/wp-content/uploads/2020/04/Land-Rover-Logo.png' WHERE name = 'Range Rover';
UPDATE car_brands SET logo_url = 'https://logos-world.net/wp-content/uploads/2020/04/Ferrari-Logo.png' WHERE name = 'Ferrari';
UPDATE car_brands SET logo_url = 'https://logos-world.net/wp-content/uploads/2020/04/Lamborghini-Logo.png' WHERE name = 'Lamborghini';
	
-- Verifiko
SELECT id, name, logo_url FROM car_brands;

USE car_rental_app;

UPDATE car_brands SET logo_url='https://raw.githubusercontent.com/filippofilip95/car-logos-dataset/master/logos/optimized/tesla.png'         WHERE name='Tesla';
UPDATE car_brands SET logo_url='https://raw.githubusercontent.com/filippofilip95/car-logos-dataset/master/logos/optimized/bmw.png'           WHERE name='BMW';
UPDATE car_brands SET logo_url='https://raw.githubusercontent.com/filippofilip95/car-logos-dataset/master/logos/optimized/mercedes-benz.png' WHERE name='Mercedes-Benz';
UPDATE car_brands SET logo_url='https://raw.githubusercontent.com/filippofilip95/car-logos-dataset/master/logos/optimized/audi.png'          WHERE name='Audi';
UPDATE car_brands SET logo_url='https://raw.githubusercontent.com/filippofilip95/car-logos-dataset/master/logos/optimized/toyota.png'        WHERE name='Toyota';
UPDATE car_brands SET logo_url='https://raw.githubusercontent.com/filippofilip95/car-logos-dataset/master/logos/optimized/honda.png'         WHERE name='Honda';
UPDATE car_brands SET logo_url='https://raw.githubusercontent.com/filippofilip95/car-logos-dataset/master/logos/optimized/ford.png'          WHERE name='Ford';
UPDATE car_brands SET logo_url='https://raw.githubusercontent.com/filippofilip95/car-logos-dataset/master/logos/optimized/chevrolet.png'     WHERE name='Chevrolet';
UPDATE car_brands SET logo_url='https://raw.githubusercontent.com/filippofilip95/car-logos-dataset/master/logos/optimized/porsche.png'       WHERE name='Porsche';
UPDATE car_brands SET logo_url='https://raw.githubusercontent.com/filippofilip95/car-logos-dataset/master/logos/optimized/land-rover.png'    WHERE name='Range Rover';
UPDATE car_brands SET logo_url='https://raw.githubusercontent.com/filippofilip95/car-logos-dataset/master/logos/optimized/ferrari.png'       WHERE name='Ferrari';
UPDATE car_brands SET logo_url='https://raw.githubusercontent.com/filippofilip95/car-logos-dataset/master/logos/optimized/lamborghini.png'   WHERE name='Lamborghini';

SELECT name, logo_url FROM car_brands;

-- Tabela per refresh tokens (KF-02) — ekzekutoje ne databazen car_rental_app
USE car_rental_app;
...
-- 1) Kush je ti dhe çfarë id ke
SELECT id, email FROM users ORDER BY id;

-- 2) Kush është pronari i veturave (user_id)
SELECT c.id AS car_id, co.user_id AS owner_user_id
FROM cars c JOIN car_owners co ON c.owner_id = co.id LIMIT 3;

-- 3) A u krijua ndonjë mesazh/bisedë
SELECT id, conversation_id, sender_id, LEFT(content,40) AS msg
FROM messages ORDER BY id DESC LIMIT 5;


SELECT b.id AS booking_id, b.user_id AS booker, co.user_id AS owner
FROM bookings b
